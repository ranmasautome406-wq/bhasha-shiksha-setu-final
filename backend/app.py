...
def create_app(config_object=Config):
    ...
    # Register blueprints
    from backend.routes import admin, auth, content, student, teacher, tutor, voice, video
    for bp in (auth.bp, content.bp, student.bp, teacher.bp, tutor.bp, voice.bp, video.bp,
